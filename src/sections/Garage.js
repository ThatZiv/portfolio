...
export default {
  meta: {
    ...
    timeline: [
      [
        'Early-June 2021',
        'The initial idea of constructing a centralized garage door module came about.'
      ],
      ['Mid-June 2021', 'Circuitry and software were schematized.'],
      [
        'July 2021',
        'Electrical components were fitted inside of a relatively small housing module.'
      ],
      [
        'Late-July 2021',
        'The project was completed and deployed on zWebserver (the internet) for family members only.'
      ],
      [
        'Later-July 2021',
        'Zua API (zWebserver) integration and authentication methods were refactored.'
      ],
      [
        'December 2021',
        'Attached camera to garage computer for live garage video feed to check if the garage is open or not.'
      ]
    ]
  },
...
function statistics() {
  return (
    <Status paper pattern="/zua_api_version/g" url="https://zavaar.net/api" />
  )
}
      ...
      images={[
        {
          ...
          imgPath: '/pics/ext/circuit.png'
        },
        {
          label: 'Data Flow Diagram',
          imgPath: '/pics/ext/flow.png'
        },
        {
          label: 'Physical Module',
          imgPath: '/pics/ext/physical.jpg'
        },
        {
          label: 'User-interface',
          imgPath: '/pics/ext/ui.PNG'
        },
        {
          label: 'Module Diagram',
          imgPath: '/pics/ext/module.jpg'
        },
        {
          label: 'Demo',
          imgPath: '/pics/garage.gif'
        }
      ]}
    />
  )
