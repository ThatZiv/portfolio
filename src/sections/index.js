...
const my = {
    ...
    "tools": {
        primary: "vscode,visualstudio,vim,neovim,atom,idea,arduino,blender,cloudflare,linux,docker,github,git,heroku,mongodb,mysql,nginx,raspberrypi,regex,ae,au,ai,pr,ps",
        secondary: [
