  ...
  return (
    <div style={{ overflow: 'scroll', height: '500px', fontFamily: 'Arial' }}>
      ...
      >
        ...
        Additionally, this project utilizes a mobile app to act as both a
        pedometer and an audio informant for the distance between the user and
        an oncoming object.
      </p>
      <br />
      <img style={{ width: '96%', height: '65%' }} src="/pics/BE1200.png" loading="lazy" decoding="async" />
      <p
        className="s1"
        style={{
          paddingTop: '7pt',
          ...
          <ol id="l2">
              ...
              <ol id="l3">
                <li data-list-text="a.">
                  ...
                  >
                    ...
                    file &gt; select This PC &gt; click downloads &gt; select
                    downloaded code (CODE located below)
                  </p>
                </li>
                <li data-list-text="b.">
                  <p
            ...
            <li data-list-text={4}>
              ...
              >
                ...
                via usb and open the mobile application
              </p>
            </li>
            <li data-list-text={5}>
              <p
            ...
            <li data-list-text={9}>
              ...
              >
                ...
                pedometer sensor and time elapsed for the trip. Turing that on
                also tracks location history and visualizes the path taken using
                the GPS on the mobile device.
              </p>
              <p
                style={{
                  paddingLeft: '77pt',
