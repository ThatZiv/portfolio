...
export default {
  meta: {
    ...
    timeline: [
      ...
      [
        '2018',
        'v0.7.0 - Designed the first user-interface (UI) with templating (Pug.js) and server-side rendering.'
      ],
      [
        '2019',
        'v1.1.0 - The Zua RESTful API releases to the public and more UI refinement.'
      ],
      ['Late-2019', 'v1.1.3 - Zua API: dynamic picture API update releases.'],
      [
        '2020',
        'v1.1.9 - "Actions on Google" update allows for all Zua subsystems to be managed through personal phone.'
      ],
      [
        '2021',
        'v1.1.10 - Zua API websocket update allows for realtime dynamic data transfer.'
      ],
      [
        'Late-2021',
        'v1.1.11 - Zua API web scraper and crawler is instantiated for wide variety of websites (TikTok, Instagram, etc.).'
      ],
      [
        '2022',
  ...
  return (
    <Grid container spacing={1}>
      ...
      <Grid item>
        <SocialMedia
          icon="desktop"
          name="User-interface Sample"
          url="https://zavaar.net/static/"
          showName
          confirmation
        />
      </Grid>
