...
export default {
    meta: {
        ...
        timeline: [
            ...
            ["January 28, 2023", "Integrated Supabase Backend-as-a-Service (BaaS) with frontend."],
            ["January 29, 2023", "Created user-authentication with PostgreSQL row-level security (RLS)."],
            ["January 29, 2023", "Finalized project submission."],
            ["January 29, 2023", "Awarded \"Best Hack for Environmental Sustainability.\""]
        ],
...
function Pictures() {
    return <Gallery images={[
        { label: "Presentations/Judging (1/2)", imgPath: "/pics/ext/sphack8/2.jpg" },
        { label: "Presentations/Judging (2/2)", imgPath: "/pics/ext/sphack8/1.jpg" },
...
function Description() {
    return <Generic entries={
        [
            {
                title: "Inspiration",
                content: "We were inspired by the growing problem of climate change to create a project that addresses the main contributor to global warming at the individual level: your carbon footprint. By creating a website where people can view and compare their carbon footprint, we can motivate people to make changes to their lifestyle to reduce their environmental impact. "
            },
            {
                title: "What it does",
            ...
            },
            {
                ...
                content: "The app was primarily built with React and Javascript for the front-end. For the back-end, we used Supabase and PostgreSQL."
            },
            {
                title: "Challenges we ran into",
                content: "We had issues with understanding the nuances of row-level security, and trouble overestimating what we could accomplish within the limited time window."
            },
            {
                title: "Accomplishments that we're proud of",
                content: "We are proud of our teamwork and our ability to collaborate to create a product better than any of us would be able to produce on our own."
            },
            {
                title: "What we learned",
                content: "We learned the importance of brainstorming and fully creating our idea and workflow before beginning to code in order to save time and energy."
            },
            {
                title: "What's next for earthly",
                content: "In the future, we will work to expand Earthly to be available as a mobile app. Furthermore, we want to connect earthly with smart devices, such as watches, to automate the tracking process without our users having to manually input their data. Finally, we hope to not just watch the carbon footprint of transportation, but also that of other activities that are detrimental to the environment, such as leaving the lights on or setting the air conditioner at a very low temperature."
            }
        ]
    } />
}
...
function Links() {
    return (<Grid container spacing={2}>
        <Grid item>
            <SocialMedia name="Project Submission" icon="fa-solid fa-envelope-circle-check" url="https://devpost.com/software/earthly-dzcu1h" />
        </Grid>
        <Grid item>
            <SocialMedia name="Live Preview" icon="fa-solid fa-globe" url="https://earthly.zavaar.net/" />
        </Grid>
        <Grid item>
            <SocialMedia icon="fa-brands fa-github" url="https://github.com/mlyoung25/earthly" />
        </Grid>
        <Grid xs={12} item>
