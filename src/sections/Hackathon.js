  ...
  return (
    <Grid spacing={1} container>
      <Grid item>
        <SocialMedia
          showName
          url="https://github.com/ThatZiv/hackathon2021wsu/"
          confirmation
        />
      </Grid>
      <Grid item>
...
function description() {
  return (
    <div style={{ overflow: "auto" }}>
      ...
      <h1>
        Friendzy - <code>Hackathon 2021 WSU</code>
      </h1>
      <p>
        Friendzy is a simple chatting application that allows users to
        communicate with each other with the option to utilize rooms
      </p>
      <h2>Contributors</h2>
      <ul>
        <li>
      ...
      <h2>Problem</h2>
      <p>
        Over the past year or so, the COVID-19 Pandemic has diminished our
        social lives due to the restrictions, especially through the holidays.
        With <strong>Friendzy</strong> users are allowed to communicate with
        each other and stay in contact through these hard times with privacy and
        speed.
      </p>
      ...
      <ul>
        ...
        <li>
          Data: All data is temporary and nothing is permanent. The temp data
          (Users and Room data) can be accessed through the predefined socket
          events.
        </li>
      </ul>
      <h2>Progression</h2>
      <p>
        All work was done during the hackathon. Express.js http server was built
        around the backend of the service, bonded with a socket.io server. The
        frontend is served via the backend web server and the client sided code
        connects to the backend socket.io server. Through this, the user is able
        to transmit data to the server and receive data from the server with
        ease.
      </p>
      <h2>Navigation</h2>
      <ul>
        <li>
          The <code>client</code> folder houses all the client sided html/js
          code
        </li>
        <li>
          <code>index.js</code> is the main file that runs the entire backend
        </li>
        <li>
          <code>users.js</code> houses the user&#39;s data (username, unique
          identifier, etc)
        </li>
        <li>
          <code>rooms.js</code> houses the room data (members ids in each room
          and unique identifier for room id)
        </li>
        <li>
          <code>routing</code> folder has the routes used for the backend web
          server
        </li>
      </ul>
      <h2>Reproduction</h2>
      <ol>
        ...
        <li>
          ...
          <pre>
            <code>
              <span>touch</span> <span>.env</span>
            </code>
          </pre>
        </li>
        <li>
          <p>
            edit the <code>.env</code> file, make sure it has the following
            contents
          </p>
          <pre>
            <code>
              <span>PORT</span>=<span>2000</span>
            </code>
          </pre>
        </li>
        <li>
        ...
        <li>
          <p>
            connect to the website @ <code>http://localhost:2000/</code>
          </p>
        </li>
      </ol>
    </div>
