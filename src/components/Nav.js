...
const Search = styled('div')(({ theme }) => ({
  ...
  backgroundColor: '#1b1b1b11', // CHANGE THIS
  '&:hover': {
          ...
          <Container>
            ...
            >
              <Typography style={{ fontSize: '0.95rem' }} variant="subtitle2">
                Last{' '}
                <a
                  style={{ textDecoration: 'none', colorAdjust: 'exact' }}
                  target="_blank"
                  rel="noreferrer"
                  href="https://github.com/ThatZiv/portfolio/commits/master"
                >
                  updated
                </a>{' '}
                on {dateCompiled}
